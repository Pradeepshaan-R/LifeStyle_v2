...
@section('content')
    <x-forms.patch :action="route('admin.variation.update',$variation)" class="was-validated" id="myForm"
        ...
        <article class="card">
            ...
            <section class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="title" name="title" readonly="readonly" required
                            @if (old('title')) value="{{ old('title') }}" @else value="{{ $variation->title }}" @endif />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name='variation_type_id' id="variation_type_id" readonly="readonly" >


                            @foreach (App\Models\VariationType::get() as $variation_type)
                            <option value="{{ $variation_type->id }}"
                                {{ $variation->variation_type_id == $variation_type->id ? 'selected' : '' }}>
            ...
            <section class="card-footer">
                <div class="row">
                    <div class="col">
                        @can('BRAND_DELETE')
                            <button type="button" url="{{ route('admin.variation.destroy', $variation->id) }}"
                                return_url="{{ route('admin.variation.index') }}"
